...
export class StorageUtil {
    ...
    public static wantSaveKeyValue(key, value) {
    ...
    private static _syncLocalData() {
        for (let uniKey in this.keyValueMap) {
            this._setData(uniKey, this.keyValueMap[uniKey]);
        }
        this.keyValueMap = {};
    }
